...
<head>
    ...
    <meta property='og:image' content='http://stevensmark.infinityfreeapp.com/assets/Food_wishes.webp'>
    <meta property='og:description' content='Built using PHP & MySQL. This is a recipe website where users can sign up & share their recipes with other users as well as comment on the recipes displayed. There is the option to create, update & delete the recipe as well as upload a photo of their favourite dishes. There is also the possibility to contact the site owner if needed.'>
    <meta property='og:url' content='http://stevensmark.infinityfreeapp.com/'>
